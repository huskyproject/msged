...
button dlg_ok =
{
    ID_OK, 13, 15, 0, 0, bf, bs, bb, "  Ok  "
};
button dlg_cancel =
{
    ID_CANCEL, 25, 15, 0, 0, bf, bs, bb, "Cancel"
};
ckbutton ck1 =
{
    3, 19, 1, 2, 0, 0, f, s, "Show Address"
};
ckbutton ck2 =
{
    4, 19, 2, 2, 0, 0, f, s, "Hard Quoting"
};
ckbutton ck3 =
{
    5, 19, 3, 2, 0, 0, f, s, "Write ^aMSGIDs"
};
ckbutton ck4 =
{
    6, 19, 4, 2, 0, 0, f, s, "Opus Dates"
};
ckbutton ck5 =
{
    7, 19, 5, 2, 0, 0, f, s, "Show SEEN-BYs"
};
ckbutton ck6 =
{
    8, 19, 6, 2, 0, 0, f, s, "Confirm Actions"
};
ckbutton ck7 =
{
    9, 19, 7, 2, 0, 0, f, s, "Use Lastread"
};
ckbutton ck8 =
{
    10, 19, 8, 2, 0, 0, f, s, "Use ^aPID"
};
ckbutton ck9 =
{
    11, 19, 9, 2, 0, 0, f, s, "Show CRs"
};
ckbutton ck10 =
{
    12, 19, 10, 2, 0, 0, f, s, "Show ImportFN"
};
ckbutton ck21 =
{
    13, 19, 11, 2, 0, 0, f, s, "Use SOT/EOT"
};
ckbutton ck22 =
{
    14, 19, 12, 2, 0, 0, f, s, "Show Time"
};
ckbutton ck23 =
{
    15, 19, 13, 2, 0, 0, f, s, "Msg#s At Top"
};
ckbutton ck11 =
{
    16, 40, 1, 25, 0, 0, f, s, "Save CC Msgs"
};
ckbutton ck12 =
{
    17, 40, 2, 25, 0, 0, f, s, "Raw CC Msgs"
};
ckbutton ck13 =
{
    17, 40, 3, 25, 0, 0, f, s, "Show Date Arvd"
};
ckbutton ck14 =
{
    19, 40, 4, 25, 0, 0, f, s, "Unused"
};
ckbutton ck15 =
{
    20, 40, 5, 25, 0, 0, f, s, "Show Real Msg#"
};
ckbutton ck16 =
{
    21, 40, 6, 25, 0, 0, f, s, "Show ^A Lines"
};
ckbutton ck17 =
{
    22, 40, 7, 25, 0, 0, f, s, "Chop Quotes"
};
ckbutton ck18 =
{
    23, 40, 8, 25, 0, 0, f, s, "Quote Quotes"
};
ckbutton ck19 =
{
    24, 40, 9, 25, 0, 0, f, s, "Show EOLs"
};
ckbutton ck20 =
{
    25, 40, 10, 25, 0, 0, f, s, "Status Bar"
};
ckbutton ck24 =
{
    26, 40, 11, 25, 0, 0, f, s, "Show System"
};
ckbutton ck25 =
{
    27, 40, 12, 25, 0, 0, f, s, "Ext Format"
};
ckbutton ck26 =
{
    28, 40, 13, 25, 0, 0, f, s, "Unused"
};
dlgbox settings =
{
    10,                  2,                  68,                  28,
...
button strok =
{
    ID_OK, 5, 3, 0, 0, bf, bs, bb, "  Ok  "
};
button strcancel =
{
    ID_CANCEL, 15, 3, 0, 0, bf, bs, bb, "Cancel"
};
editf editfld =
{
    ID_EDIT, 1, 1, 0, 0, f, f, editbuf, 20, 0
};
dlgbox get_string =
{
    10,              5,              60,              20,              BLACK | _LGREY,
    BLACK | _LGREY,
    LCYAN | _LGREY,
    INSBDR | SHADOW,
    NULL,            3,
...
static button b_one =
{
    ID_ONE, 0, 0, 0, 0, 0, 0, 0, NULL
};
static button b_two =
{
    ID_TWO, 0, 0, 0, 0, 0, 0, 0, NULL
};
static button b_three =
{
    ID_THREE, 0, 0, 0, 0, 0, 0, 0, NULL
};
static dlgbox cb =
{
    0, 0, 0, 0,    0,    0,    0,    INSBDR | SHADOW,    NULL,    1,
    {{D_BUT,0, (void *)&b_one}, {D_BUT, 0, (void *)&b_two}, {D_BUT, 0, (void *)&b_three}}
};
/*
...
MC MouseMnu =
{
    0,     0,     0,                  0,                        CMD_HOR | CMD_PRT,
    NBDR,
    0,
    1,     7,     0,
    4,
    {{ID_SCAN,0,     scan_all_areas,     NULL,                     "Scan",
      'c',
      0,
      0},
     {ID_LIST,0,     dolist,             NULL,                     "List",
      'l',
      0,
      7},
     {ID_SETUP,0,     set_switch,         NULL,                     "Setup",
      's',
      0,
      14},
     {ID_QUIT,CMD_EXIT, NULL,            NULL,                     "Quit",
      'q', 0,     28}}
};
/*
...
int ChoiceBox(char * title, char * txt, char * b1, char * b2, char * b3)
{
    ...
    if(b1 != NULL)
    {
        SetupButton(&b_one,
                    ...
                    pos,
                    height,
                    (unsigned char)cm[DL_BSEL],
                    (unsigned char)cm[DL_BNRM],
                    (unsigned char)cm[DL_BSHD]);
        pos += strlen(b1) + 6;
    }
