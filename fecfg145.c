...
int read_fe_config(CONFIG * c, FILE * fp)
{
    ...
    pbuf += _MAXPATH;
    memcpy(c->DBQueuePath, pbuf, _MAXPATH);
    pbuf += _MAXPATH;
    memcpy(c->unused3, pbuf, 32);
    pbuf += 32;
