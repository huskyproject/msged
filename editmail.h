...
{NULL,        NULL,               NULL,               NULL,
 e_uudecode,
 NULL,        NULL,               NULL,               /* 0 */
 backspace,   tabit,              NULL,               emacskill,
 NULL,
 newline,
 NULL,        NULL,               /* 8 */
 NULL,        NULL,               NULL,               NULL,
...
{NULL,             NULL,                NULL,                   NULL,
 ...
 NULL,
 NULL,             NULL,                NULL,                         /* 8 */
 toggle_quote,     outtext,             editheader,             rotate,
 setup,
 NULL,             unblock,             imptxt,                 /* 10 */
 shellos,          paste,               NULL,                   NULL,
 NULL,
 NULL,             anchor,              quit,                   /* 18 */
 delete_line,      NULL,                NULL,                   do_help,
 NULL,
 killeol,          zap_quotes,          NULL,                   /* 20 */
 NULL,             NULL,                NULL,                   NULL,
 NULL,
 NULL,             cut,                 NULL,                   /* 28 */
 bytecount,        NULL,                NULL,                   NULL,
 NULL,
 NULL,             NULL,                NULL,                   /* 30 */
 NULL,             NULL,                NULL,                   NULL,
 NULL,
 ...
 NULL,
 NULL,             NULL,                go_bol,                 /* 40 */
 go_up,            go_pgup,             NULL,                   go_left,
 NULL,
 go_right,         NULL,                go_eol,                 /* 48 */
 go_down,          go_pgdown,           toggle_ins,
 delete_character,
 NULL,
 NULL,             NULL,                NULL,                   /* 50 */
 NULL,             NULL,                NULL,                   NULL,
 ...
 NULL,
 NULL,             NULL,                NULL,                   /* 68 */
 NULL,             NULL,                NULL,                   go_word_left,
 go_word_right,    go_bom,              go_bos,                 go_tom,     /* 70 */
 doscmd,           NULL,                NULL,                   NULL,
 NULL,
 NULL,             NULL,                NULL,                 /* 78 */
 NULL,             NULL,                NULL,                   NULL,
 go_tos,
...
const struct _command editcmds[] = {   {
                                       ...
                                       {"setup",
                                        setup                                                                                  },
                                       {"zap",      zap_quotes                 },{NULL, NULL                       }};

#endif // ifndef __EDITMAIL_H__
