        ...
        if(areano >= 0)
        {
            ...
            if(a->scanned)
            {
                ...
                sprintf(line,
                        ...
                        a->description);
                line[strlen(line)] = ' ';
                sprintf(line + maxx - 23, "%6lu%6lu%6lu", a->messages, unread, last);
            }
            else
            {
...
static void setup_areabox_coordinates(int * currItem,
                                      int * curY,
                                      int * Top,
                                      int * y2,
                                      int * page,
                   ...
                   int indent)
{
    ...
    currItem = def;
    setup_areabox_coordinates(&currItem, &curY, &Top, &y2, &page, y1, real_y2, itemCnt);
    done = 0;
    TTBeginOutput();
                ...
                switch(Msg)
                {
                    ...
                    case Key_Rgt:
                        ...
                        if(group_getareano(currItem) >= 0)
                        {
                            size_t i;
                            i =
                                (size_t)(((char *)(strchr(Itms[currItem] + 1,
                                                          ' '))) - Itms[currItem]);
                            i--;
                    ...
                    case Key_C_G:
                        ...
                        if(i)
                        {
                            ...
                            setup_areabox_coordinates(&currItem,
                                                      &curY,
                                                      &Top,
                                                      &y2,
                                                      &page,
