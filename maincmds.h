...
{NULL,                 NULL,                     NULL,
 NULL,
 uudecode,             NULL,                     makefreq,
 NULL,                 /* 0 */
 edithdr,              go_next,                  NULL,
 NULL,
 NULL,
 right,                chngnodel,                NULL,           /* 8 */
 NULL,                 NULL,                     NULL,
 NULL,
 NULL,
 chngname,             NULL,                     chngaddr,       /* 10 */
 NULL,                 NULL,                     NULL,
 quit,
 NULL,
 NULL,                 NULL,                     NULL,           /* 18 */
 NULL,                 rundos,                   NULL,
 scan_unscanned_areas, NULL,
 NULL,                 NULL,                     NULL,                 /* 20 */
 NULL,                 NULL,                     scan_all_areas,
 next_area,
 NULL,
 prev_area,            NULL,                     NULL,                 /* 28 */
 NULL,                 NULL,                     NULL,
 NULL,
 NULL,
 NULL,                 NULL,                     NULL,        /* 30 */
...
{NULL,       NULL,          NULL,            NULL,
 ...
 NULL,
 NULL,       NULL,                /* 8 */
 quote,      outtxt,        newmsg,          reply,
 sel_chs,
 replyextra,
 followup,   NULL,          /* 10 */
 go_dos,     pmail,         NULL,            NULL,
 NULL,
 NULL,
 quit,       set,           /* 18 */
 delete,     search,        gotomsg0,        do_help,
 NULL,
 NULL,
 list,       NULL,          /* 20 */
 NULL,       NULL,          NULL,            NULL,
 ...
 quit,
 change,     view,          /* 28 */
 hex_dump,   reply_oarea,   move,            NULL,
 NULL,
 NULL,
 NULL,       NULL,          /* 30 */
 NULL,       NULL,          NULL,            NULL,
...
const struct _command maincmds[] = {   {
                                       ...
                                       {"down",
                                        Go_Dwn                                           },
                                       {"up",            Go_Up                                   },{"help", do_help            },{NULL, NULL}};

#endif // ifndef __MAINCMDS_H__
